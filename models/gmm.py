...
class GMM:
    ...
    def fit(self, ckpt_dir: str, train_loader: DataLoader, valid_loader: DataLoader) -> None:
        ...
        for epoch in range(self.epochs):
            ...
            print(f'Epoch {epoch + 1}: train loss {llk_val} = joint {-joint_llk_val} '
    ...
    def adapt(self, ckpt_dir: str, baseline_acc: float,
        ...
        for epoch in range(self.adapt_epochs):
            ...
            test_acc = self.evaluate(test_loader) if test_loader is not None else float('nan')

            print(f'Epoch {epoch + 1}: train loss {llk_val}, ' \
                    f'test accuracy {test_acc}, delta {test_acc - baseline_acc}')
